...
import { Beaker, type LucideIcon } from "lucide-react"
  ...
  return (
    <section ref={containerRef} className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {!hasExperiments && (
          <EmptyPlaceholder
            title="Lab log is empty"
            description="Experiments and prototypes will appear here once published."
            icon={Beaker}
            variant="violet"
            className="max-w-3xl"
          />
          ...
          <>
            ...
            >
              <p className="text-lg text-muted-foreground">
                A collection of experimental projects pushing the boundaries of AI, creative coding, and
