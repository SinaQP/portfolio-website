            ...
            <>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wide mb-2">Issuer</h4>
                    <p className="text-lg text-foreground">{selectedCertificate.issuer}</p>
                  </div>

                  <div className="flex items-center gap-4">
                    <div>
                      <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wide mb-2">Date</h4>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedCertificate.skills.map((skill, index) => (
                          <span key={index} className="px-3 py-1 rounded-md bg-muted/50 text-sm text-muted-foreground">
                            {skill}
                          </span>
                        ))}
                      </div>
